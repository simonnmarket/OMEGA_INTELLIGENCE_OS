...
public:
   ...
   {
      if(!m_logger.is_initialized()) { Print("[QENT] Logger não inicializado"); ExpertRemove(); }
   ...
   ~QuantumEntanglement() { m_logger.log_info("[QENT] Simulador de entrelaçamento encerrado para " + m_symbol); }
};
