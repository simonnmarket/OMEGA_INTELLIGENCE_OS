"""
WRAPPER AUTOMATICO — GENESIS_INCLUDES → NCNTModule v2.0
...
class genesis_includesWrapper(NCNTModule):
    """Wrapper seguro e compliant para genesis_includes"""
    ...
    def __init__(self):
        super().__init__(
            module_name="genesis_includes_wrapper",
            config={"wrapped_module": "genesis_includes"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/genesis_includes.py"
            ...
            self.logger.critical(f"Falha critica em genesis_includes: {e}")
