"""
WRAPPER AUTOMATICO — FEEDBACKLOOP_MODULE → NCNTModule v2.0
...
class feedbackloop_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para feedbackloop_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="feedbackloop_module_wrapper",
            config={"wrapped_module": "feedbackloop_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "06-Monitoramento/feedbackloop_module.py"
            ...
            self.logger.critical(f"Falha critica em feedbackloop_module: {e}")
