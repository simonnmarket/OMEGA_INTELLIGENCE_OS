"""
WRAPPER AUTOMATICO — INCIDENTRESPONSE_MODULE → NCNTModule v2.0
...
class incidentresponse_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para incidentresponse_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="incidentresponse_module_wrapper",
            config={"wrapped_module": "incidentresponse_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/Incident-Response/incidentresponse_module.py"
            ...
            self.logger.critical(f"Falha critica em incidentresponse_module: {e}")
