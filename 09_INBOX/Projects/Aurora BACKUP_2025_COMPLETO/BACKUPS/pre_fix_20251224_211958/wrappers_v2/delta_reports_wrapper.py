"""
WRAPPER AUTOMATICO — DELTA_REPORTS → NCNTModule v2.0
...
class delta_reportsWrapper(NCNTModule):
    """Wrapper seguro e compliant para delta_reports"""
    ...
    def __init__(self):
        super().__init__(
            module_name="delta_reports_wrapper",
            config={"wrapped_module": "delta_reports"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Post-Trade/delta_reports.py"
            ...
            self.logger.critical(f"Falha critica em delta_reports: {e}")
