"""
WRAPPER AUTOMATICO — RISK_MODULE → NCNTModule v2.0
...
class risk_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para risk_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="risk_module_wrapper",
            config={"wrapped_module": "risk_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Risk-Controls/risk_module.py"
            ...
            self.logger.critical(f"Falha critica em risk_module: {e}")
