"""
WRAPPER AUTOMATICO — ALPHA_MOMENTUM → NCNTModule v2.0
...
class alpha_momentumWrapper(NCNTModule):
    """Wrapper seguro e compliant para alpha_momentum"""
    ...
    def __init__(self):
        super().__init__(
            module_name="alpha_momentum_wrapper",
            config={"wrapped_module": "alpha_momentum"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategies/alpha_momentum.py"
            ...
            self.logger.critical(f"Falha critica em alpha_momentum: {e}")
