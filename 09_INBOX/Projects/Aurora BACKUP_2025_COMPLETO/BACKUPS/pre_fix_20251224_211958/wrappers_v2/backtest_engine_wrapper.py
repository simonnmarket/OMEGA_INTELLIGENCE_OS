"""
WRAPPER AUTOMATICO — BACKTEST_ENGINE → NCNTModule v2.0
...
class backtest_engineWrapper(NCNTModule):
    """Wrapper seguro e compliant para backtest_engine"""
    ...
    def __init__(self):
        super().__init__(
            module_name="backtest_engine_wrapper",
            config={"wrapped_module": "backtest_engine"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/QA-Backtesting/backtest_engine.py"
            ...
            self.logger.critical(f"Falha critica em backtest_engine: {e}")
