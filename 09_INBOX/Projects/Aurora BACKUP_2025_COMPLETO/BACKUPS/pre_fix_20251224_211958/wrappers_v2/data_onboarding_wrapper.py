"""
WRAPPER AUTOMATICO — DATA_ONBOARDING → NCNTModule v2.0
...
class data_onboardingWrapper(NCNTModule):
    """Wrapper seguro e compliant para data_onboarding"""
    ...
    def __init__(self):
        super().__init__(
            module_name="data_onboarding_wrapper",
            config={"wrapped_module": "data_onboarding"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/Onboarding/data_onboarding.py"
            ...
            self.logger.critical(f"Falha critica em data_onboarding: {e}")
