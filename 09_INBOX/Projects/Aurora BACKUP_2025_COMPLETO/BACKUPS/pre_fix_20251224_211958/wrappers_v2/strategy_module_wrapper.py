"""
WRAPPER AUTOMATICO — STRATEGY_MODULE → NCNTModule v2.0
...
class strategy_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para strategy_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="strategy_module_wrapper",
            config={"wrapped_module": "strategy_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategy_module.py"
            ...
            self.logger.critical(f"Falha critica em strategy_module: {e}")
