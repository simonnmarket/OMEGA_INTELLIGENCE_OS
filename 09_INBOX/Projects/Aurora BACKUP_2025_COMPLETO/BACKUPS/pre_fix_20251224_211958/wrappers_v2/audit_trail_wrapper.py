"""
WRAPPER AUTOMATICO — AUDIT_TRAIL → NCNTModule v2.0
...
class audit_trailWrapper(NCNTModule):
    """Wrapper seguro e compliant para audit_trail"""
    ...
    def __init__(self):
        super().__init__(
            module_name="audit_trail_wrapper",
            config={"wrapped_module": "audit_trail"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Compliance-Audit/audit_trail.py"
            ...
            self.logger.critical(f"Falha critica em audit_trail: {e}")
