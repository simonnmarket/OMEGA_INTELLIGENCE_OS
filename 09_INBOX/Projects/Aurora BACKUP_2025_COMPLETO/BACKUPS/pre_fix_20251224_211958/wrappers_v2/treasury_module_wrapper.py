"""
WRAPPER AUTOMATICO — TREASURY_MODULE → NCNTModule v2.0
...
class treasury_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para treasury_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="treasury_module_wrapper",
            config={"wrapped_module": "treasury_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Treasury-Capital/treasury_module.py"
            ...
            self.logger.critical(f"Falha critica em treasury_module: {e}")
