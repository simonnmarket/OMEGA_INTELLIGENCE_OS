"""
WRAPPER AUTOMATICO — GENERATE_COMPLETE_REPORT → NCNTModule v2.0
...
class generate_complete_reportWrapper(NCNTModule):
    """Wrapper seguro e compliant para generate_complete_report"""
    ...
    def __init__(self):
        super().__init__(
            module_name="generate_complete_report_wrapper",
            config={"wrapped_module": "generate_complete_report"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/generate_complete_report.py"
            ...
            self.logger.critical(f"Falha critica em generate_complete_report: {e}")
