"""
WRAPPER AUTOMATICO — CAPITAL_MANAGER → NCNTModule v2.0
...
class capital_managerWrapper(NCNTModule):
    """Wrapper seguro e compliant para capital_manager"""
    ...
    def __init__(self):
        super().__init__(
            module_name="capital_manager_wrapper",
            config={"wrapped_module": "capital_manager"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Treasury-Capital/capital_manager.py"
            ...
            self.logger.critical(f"Falha critica em capital_manager: {e}")
