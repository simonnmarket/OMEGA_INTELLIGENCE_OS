"""
WRAPPER AUTOMATICO — COMPLIANCE_MODULE → NCNTModule v2.0
...
class compliance_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para compliance_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="compliance_module_wrapper",
            config={"wrapped_module": "compliance_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Compliance-Audit/compliance_module.py"
            ...
            self.logger.critical(f"Falha critica em compliance_module: {e}")
