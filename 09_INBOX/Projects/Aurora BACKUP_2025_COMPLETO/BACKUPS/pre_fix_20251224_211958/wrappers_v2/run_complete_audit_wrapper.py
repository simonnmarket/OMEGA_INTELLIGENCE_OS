"""
WRAPPER AUTOMATICO — RUN_COMPLETE_AUDIT → NCNTModule v2.0
...
class run_complete_auditWrapper(NCNTModule):
    """Wrapper seguro e compliant para run_complete_audit"""
    ...
    def __init__(self):
        super().__init__(
            module_name="run_complete_audit_wrapper",
            config={"wrapped_module": "run_complete_audit"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/run_complete_audit.py"
            ...
            self.logger.critical(f"Falha critica em run_complete_audit: {e}")
