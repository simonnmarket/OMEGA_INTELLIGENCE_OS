"""
WRAPPER AUTOMATICO — STRATEGY_TEMPLATE → NCNTModule v2.0
...
class strategy_templateWrapper(NCNTModule):
    """Wrapper seguro e compliant para strategy_template"""
    ...
    def __init__(self):
        super().__init__(
            module_name="strategy_template_wrapper",
            config={"wrapped_module": "strategy_template"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategy_modules/templates/strategy_template.py"
            ...
            self.logger.critical(f"Falha critica em strategy_template: {e}")
