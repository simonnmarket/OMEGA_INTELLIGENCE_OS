"""
WRAPPER AUTOMATICO — CONNECTION → NCNTModule v2.0
...
class connectionWrapper(NCNTModule):
    """Wrapper seguro e compliant para connection"""
    ...
    def __init__(self):
        super().__init__(
            module_name="connection_wrapper",
            config={"wrapped_module": "connection"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/database/connection.py"
            ...
            self.logger.critical(f"Falha critica em connection: {e}")
