"""
WRAPPER AUTOMATICO — REALTIMEDASHBOARD_MODULE → NCNTModule v2.0
...
class realtimedashboard_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para realtimedashboard_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="realtimedashboard_module_wrapper",
            config={"wrapped_module": "realtimedashboard_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Real-Time-Dashboard/realtimedashboard_module.py"
            ...
            self.logger.critical(f"Falha critica em realtimedashboard_module: {e}")
