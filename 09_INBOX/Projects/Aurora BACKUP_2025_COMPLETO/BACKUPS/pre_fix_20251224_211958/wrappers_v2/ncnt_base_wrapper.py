"""
WRAPPER AUTOMATICO — NCNT_BASE → NCNTModule v2.0
...
class ncnt_baseWrapper(NCNTModule):
    """Wrapper seguro e compliant para ncnt_base"""
    ...
    def __init__(self):
        super().__init__(
            module_name="ncnt_base_wrapper",
            config={"wrapped_module": "ncnt_base"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "modules/ncnt_base.py"
            ...
            self.logger.critical(f"Falha critica em ncnt_base: {e}")
