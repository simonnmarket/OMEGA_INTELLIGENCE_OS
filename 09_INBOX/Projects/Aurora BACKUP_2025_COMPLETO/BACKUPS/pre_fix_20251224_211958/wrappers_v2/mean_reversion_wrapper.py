"""
WRAPPER AUTOMATICO — MEAN_REVERSION → NCNTModule v2.0
...
class mean_reversionWrapper(NCNTModule):
    """Wrapper seguro e compliant para mean_reversion"""
    ...
    def __init__(self):
        super().__init__(
            module_name="mean_reversion_wrapper",
            config={"wrapped_module": "mean_reversion"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategies/mean_reversion.py"
            ...
            self.logger.critical(f"Falha critica em mean_reversion: {e}")
