"""
WRAPPER AUTOMATICO — MODELS → NCNTModule v2.0
...
class modelsWrapper(NCNTModule):
    """Wrapper seguro e compliant para models"""
    ...
    def __init__(self):
        super().__init__(
            module_name="models_wrapper",
            config={"wrapped_module": "models"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/database/models.py"
            ...
            self.logger.critical(f"Falha critica em models: {e}")
