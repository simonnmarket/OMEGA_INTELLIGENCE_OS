"""
WRAPPER AUTOMATICO — CICDPIPELINE_MODULE → NCNTModule v2.0
...
class cicdpipeline_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para cicdpipeline_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="cicdpipeline_module_wrapper",
            config={"wrapped_module": "cicdpipeline_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/CI-CD/cicdpipeline_module.py"
            ...
            self.logger.critical(f"Falha critica em cicdpipeline_module: {e}")
