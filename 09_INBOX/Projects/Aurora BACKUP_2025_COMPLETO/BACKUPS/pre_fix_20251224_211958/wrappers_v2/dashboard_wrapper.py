"""
WRAPPER AUTOMATICO — DASHBOARD → NCNTModule v2.0
...
class dashboardWrapper(NCNTModule):
    """Wrapper seguro e compliant para dashboard"""
    ...
    def __init__(self):
        super().__init__(
            module_name="dashboard_wrapper",
            config={"wrapped_module": "dashboard"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Real-Time-Dashboard/dashboard.py"
            ...
            self.logger.critical(f"Falha critica em dashboard: {e}")
