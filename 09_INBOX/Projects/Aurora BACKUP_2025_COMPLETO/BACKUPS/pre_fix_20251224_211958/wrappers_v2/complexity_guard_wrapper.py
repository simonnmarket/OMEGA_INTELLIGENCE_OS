"""
WRAPPER AUTOMATICO — COMPLEXITY_GUARD → NCNTModule v2.0
...
class complexity_guardWrapper(NCNTModule):
    """Wrapper seguro e compliant para complexity_guard"""
    ...
    def __init__(self):
        super().__init__(
            module_name="complexity_guard_wrapper",
            config={"wrapped_module": "complexity_guard"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/complexity_guard.py"
            ...
            self.logger.critical(f"Falha critica em complexity_guard: {e}")
