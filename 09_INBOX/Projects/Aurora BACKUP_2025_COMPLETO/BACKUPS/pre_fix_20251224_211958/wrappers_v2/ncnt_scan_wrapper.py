"""
WRAPPER AUTOMATICO — NCNT_SCAN → NCNTModule v2.0
...
class ncnt_scanWrapper(NCNTModule):
    """Wrapper seguro e compliant para ncnt_scan"""
    ...
    def __init__(self):
        super().__init__(
            module_name="ncnt_scan_wrapper",
            config={"wrapped_module": "ncnt_scan"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "ncnt_scan.py"
            ...
            self.logger.critical(f"Falha critica em ncnt_scan: {e}")
