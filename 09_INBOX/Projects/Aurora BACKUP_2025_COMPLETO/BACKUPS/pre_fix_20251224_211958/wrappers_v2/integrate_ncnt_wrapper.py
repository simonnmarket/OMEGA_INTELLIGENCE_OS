"""
WRAPPER AUTOMATICO — INTEGRATE_NCNT → NCNTModule v2.0
...
class integrate_ncntWrapper(NCNTModule):
    """Wrapper seguro e compliant para integrate_ncnt"""
    ...
    def __init__(self):
        super().__init__(
            module_name="integrate_ncnt_wrapper",
            config={"wrapped_module": "integrate_ncnt"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "integrate_ncnt.py"
            ...
            self.logger.critical(f"Falha critica em integrate_ncnt: {e}")
