"""
WRAPPER AUTOMATICO — ONBOARDING_MODULE → NCNTModule v2.0
...
class onboarding_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para onboarding_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="onboarding_module_wrapper",
            config={"wrapped_module": "onboarding_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/Onboarding/onboarding_module.py"
            ...
            self.logger.critical(f"Falha critica em onboarding_module: {e}")
