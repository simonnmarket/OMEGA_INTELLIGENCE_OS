"""
WRAPPER AUTOMATICO — RECONCILIATION → NCNTModule v2.0
...
class reconciliationWrapper(NCNTModule):
    """Wrapper seguro e compliant para reconciliation"""
    ...
    def __init__(self):
        super().__init__(
            module_name="reconciliation_wrapper",
            config={"wrapped_module": "reconciliation"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Post-Trade/reconciliation.py"
            ...
            self.logger.critical(f"Falha critica em reconciliation: {e}")
