...
private:
   ...
   void log_regime()
   {
      ...
      int sz = ArraySize(m_regime_history);
      ArrayResize(m_regime_history, sz+1);
      m_regime_history[sz] = entry;
      if(m_logger) m_logger->log_info("[REGIME] Regime atual: " + m_current_regime);
   }
