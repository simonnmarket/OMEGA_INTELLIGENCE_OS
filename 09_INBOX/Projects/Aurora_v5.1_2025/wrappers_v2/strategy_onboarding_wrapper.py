"""
WRAPPER AUTOMATICO — STRATEGY_ONBOARDING → NCNTModule v2.0
...
class strategy_onboardingWrapper(NCNTModule):
    """Wrapper seguro e compliant para strategy_onboarding"""
    ...
    def __init__(self):
        super().__init__(
            module_name="strategy_onboarding_wrapper",
            config={"wrapped_module": "strategy_onboarding"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/Onboarding/strategy_onboarding.py"
            ...
            self.logger.critical(f"Falha critica em strategy_onboarding: {e}")
