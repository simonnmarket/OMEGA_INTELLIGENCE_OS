"""
WRAPPER AUTOMATICO — FIX_REPORT_ERRORS → NCNTModule v2.0
...
class fix_report_errorsWrapper(NCNTModule):
    """Wrapper seguro e compliant para fix_report_errors"""
    ...
    def __init__(self):
        super().__init__(
            module_name="fix_report_errors_wrapper",
            config={"wrapped_module": "fix_report_errors"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/fix_report_errors.py"
            ...
            self.logger.critical(f"Falha critica em fix_report_errors: {e}")
