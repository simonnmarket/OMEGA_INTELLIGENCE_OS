"""
WRAPPER AUTOMATICO — CREATE_STRUCTURE → NCNTModule v2.0
...
class create_structureWrapper(NCNTModule):
    """Wrapper seguro e compliant para create_structure"""
    ...
    def __init__(self):
        super().__init__(
            module_name="create_structure_wrapper",
            config={"wrapped_module": "create_structure"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "create_structure.py"
            ...
            self.logger.critical(f"Falha critica em create_structure: {e}")
