"""
WRAPPER AUTOMATICO — INTERFACE → NCNTModule v2.0
...
class interfaceWrapper(NCNTModule):
    """Wrapper seguro e compliant para interface"""
    ...
    def __init__(self):
        super().__init__(
            module_name="interface_wrapper",
            config={"wrapped_module": "interface"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategy_modules/interface.py"
            ...
            self.logger.critical(f"Falha critica em interface: {e}")
