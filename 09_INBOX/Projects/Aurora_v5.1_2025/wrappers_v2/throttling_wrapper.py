"""
WRAPPER AUTOMATICO — THROTTLING → NCNTModule v2.0
...
class throttlingWrapper(NCNTModule):
    """Wrapper seguro e compliant para throttling"""
    ...
    def __init__(self):
        super().__init__(
            module_name="throttling_wrapper",
            config={"wrapped_module": "throttling"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Execution-Window/throttling.py"
            ...
            self.logger.critical(f"Falha critica em throttling: {e}")
