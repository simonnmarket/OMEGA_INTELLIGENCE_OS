"""
WRAPPER AUTOMATICO — MODULEREGISTRY → NCNTModule v2.0
...
class moduleregistryWrapper(NCNTModule):
    """Wrapper seguro e compliant para moduleregistry"""
    ...
    def __init__(self):
        super().__init__(
            module_name="moduleregistry_wrapper",
            config={"wrapped_module": "moduleregistry"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/moduleregistry.py"
            ...
            self.logger.critical(f"Falha critica em moduleregistry: {e}")
