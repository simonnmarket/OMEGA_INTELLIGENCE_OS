"""
WRAPPER AUTOMATICO — BACKTEST_RUNNER_V3 → NCNTModule v2.0
...
class backtest_runner_v3Wrapper(NCNTModule):
    """Wrapper seguro e compliant para backtest_runner_v3"""
    ...
    def __init__(self):
        super().__init__(
            module_name="backtest_runner_v3_wrapper",
            config={"wrapped_module": "backtest_runner_v3"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/backtesting/backtest_runner_v3.py"
            ...
            self.logger.critical(f"Falha critica em backtest_runner_v3: {e}")
