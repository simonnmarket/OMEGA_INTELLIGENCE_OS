"""
WRAPPER AUTOMATICO — QABACKTESTING_MODULE → NCNTModule v2.0
...
class qabacktesting_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para qabacktesting_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="qabacktesting_module_wrapper",
            config={"wrapped_module": "qabacktesting_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/QA-Backtesting/qabacktesting_module.py"
            ...
            self.logger.critical(f"Falha critica em qabacktesting_module: {e}")
