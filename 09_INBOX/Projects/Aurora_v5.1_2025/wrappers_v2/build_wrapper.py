"""
WRAPPER AUTOMATICO — BUILD → NCNTModule v2.0
...
class buildWrapper(NCNTModule):
    """Wrapper seguro e compliant para build"""
    ...
    def __init__(self):
        super().__init__(
            module_name="build_wrapper",
            config={"wrapped_module": "build"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/CI-CD/stages/build.py"
            ...
            self.logger.critical(f"Falha critica em build: {e}")
