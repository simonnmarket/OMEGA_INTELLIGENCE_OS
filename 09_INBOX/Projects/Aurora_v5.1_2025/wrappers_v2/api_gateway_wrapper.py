"""
WRAPPER AUTOMATICO — API_GATEWAY → NCNTModule v2.0
...
class api_gatewayWrapper(NCNTModule):
    """Wrapper seguro e compliant para api_gateway"""
    ...
    def __init__(self):
        super().__init__(
            module_name="api_gateway_wrapper",
            config={"wrapped_module": "api_gateway"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Engineering-Infra/api_gateway.py"
            ...
            self.logger.critical(f"Falha critica em api_gateway: {e}")
