"""
WRAPPER AUTOMATICO — __INIT__ → NCNTModule v2.0
...
class __init__Wrapper(NCNTModule):
    """Wrapper seguro e compliant para __init__"""
    ...
    def __init__(self):
        super().__init__(
            module_name="__init___wrapper",
            config={"wrapped_module": "__init__"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/tools/cli/__init__.py"
            ...
            self.logger.critical(f"Falha critica em __init__: {e}")
