"""
WRAPPER AUTOMATICO — EXECUTIONWINDOW_MODULE → NCNTModule v2.0
...
class executionwindow_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para executionwindow_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="executionwindow_module_wrapper",
            config={"wrapped_module": "executionwindow_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "03-Operacoes-Diarias/Execution-Window/executionwindow_module.py"
            ...
            self.logger.critical(f"Falha critica em executionwindow_module: {e}")
