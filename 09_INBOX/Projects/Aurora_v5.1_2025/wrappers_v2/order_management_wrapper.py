"""
WRAPPER AUTOMATICO — ORDER_MANAGEMENT → NCNTModule v2.0
...
class order_managementWrapper(NCNTModule):
    """Wrapper seguro e compliant para order_management"""
    ...
    def __init__(self):
        super().__init__(
            module_name="order_management_wrapper",
            config={"wrapped_module": "order_management"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/order_management.py"
            ...
            self.logger.critical(f"Falha critica em order_management: {e}")
