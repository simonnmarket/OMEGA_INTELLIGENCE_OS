"""
WRAPPER AUTOMATICO — REGULATORY_CONTEXT → NCNTModule v2.0
...
class regulatory_contextWrapper(NCNTModule):
    """Wrapper seguro e compliant para regulatory_context"""
    ...
    def __init__(self):
        super().__init__(
            module_name="regulatory_context_wrapper",
            config={"wrapped_module": "regulatory_context"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/regulatory_context.py"
            ...
            self.logger.critical(f"Falha critica em regulatory_context: {e}")
