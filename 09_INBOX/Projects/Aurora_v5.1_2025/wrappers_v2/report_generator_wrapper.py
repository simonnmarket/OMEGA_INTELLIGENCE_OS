"""
WRAPPER AUTOMATICO — REPORT_GENERATOR → NCNTModule v2.0
...
class report_generatorWrapper(NCNTModule):
    """Wrapper seguro e compliant para report_generator"""
    ...
    def __init__(self):
        super().__init__(
            module_name="report_generator_wrapper",
            config={"wrapped_module": "report_generator"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Compliance-Audit/report_generator.py"
            ...
            self.logger.critical(f"Falha critica em report_generator: {e}")
