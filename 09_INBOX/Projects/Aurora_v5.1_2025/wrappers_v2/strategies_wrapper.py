"""
WRAPPER AUTOMATICO — STRATEGIES → NCNTModule v2.0
...
class strategiesWrapper(NCNTModule):
    """Wrapper seguro e compliant para strategies"""
    ...
    def __init__(self):
        super().__init__(
            module_name="strategies_wrapper",
            config={"wrapped_module": "strategies"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/api/endpoints/strategies.py"
            ...
            self.logger.critical(f"Falha critica em strategies: {e}")
