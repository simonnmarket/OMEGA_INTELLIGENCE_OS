"""
WRAPPER AUTOMATICO — COUNTERPARTY_ONBOARDING → NCNTModule v2.0
...
class counterparty_onboardingWrapper(NCNTModule):
    """Wrapper seguro e compliant para counterparty_onboarding"""
    ...
    def __init__(self):
        super().__init__(
            module_name="counterparty_onboarding_wrapper",
            config={"wrapped_module": "counterparty_onboarding"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "02-Processos-Chave/Onboarding/counterparty_onboarding.py"
            ...
            self.logger.critical(f"Falha critica em counterparty_onboarding: {e}")
