"""
WRAPPER AUTOMATICO — ALLOCATION_ENGINE → NCNTModule v2.0
...
class allocation_engineWrapper(NCNTModule):
    """Wrapper seguro e compliant para allocation_engine"""
    ...
    def __init__(self):
        super().__init__(
            module_name="allocation_engine_wrapper",
            config={"wrapped_module": "allocation_engine"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Treasury-Capital/allocation_engine.py"
            ...
            self.logger.critical(f"Falha critica em allocation_engine: {e}")
