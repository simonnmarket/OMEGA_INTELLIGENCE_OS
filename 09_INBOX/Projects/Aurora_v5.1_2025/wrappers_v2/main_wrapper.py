"""
WRAPPER AUTOMATICO — MAIN → NCNTModule v2.0
...
class mainWrapper(NCNTModule):
    """Wrapper seguro e compliant para main"""
    ...
    def __init__(self):
        super().__init__(
            module_name="main_wrapper",
            config={"wrapped_module": "main"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/api/main.py"
            ...
            self.logger.critical(f"Falha critica em main: {e}")
