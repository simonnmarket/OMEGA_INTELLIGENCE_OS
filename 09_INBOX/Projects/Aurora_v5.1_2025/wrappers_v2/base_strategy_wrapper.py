"""
WRAPPER AUTOMATICO — BASE_STRATEGY → NCNTModule v2.0
...
class base_strategyWrapper(NCNTModule):
    """Wrapper seguro e compliant para base_strategy"""
    ...
    def __init__(self):
        super().__init__(
            module_name="base_strategy_wrapper",
            config={"wrapped_module": "base_strategy"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategies/base_strategy.py"
            ...
            self.logger.critical(f"Falha critica em base_strategy: {e}")
