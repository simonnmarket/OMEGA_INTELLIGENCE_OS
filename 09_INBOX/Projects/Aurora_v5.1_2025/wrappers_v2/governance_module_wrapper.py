"""
WRAPPER AUTOMATICO — GOVERNANCE_MODULE → NCNTModule v2.0
...
class governance_moduleWrapper(NCNTModule):
    """Wrapper seguro e compliant para governance_module"""
    ...
    def __init__(self):
        super().__init__(
            module_name="governance_module_wrapper",
            config={"wrapped_module": "governance_module"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/governance_module.py"
            ...
            self.logger.critical(f"Falha critica em governance_module: {e}")
