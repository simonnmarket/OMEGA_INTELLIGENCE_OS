"""
WRAPPER AUTOMATICO — NCNT_CLI → NCNTModule v2.0
...
class ncnt_cliWrapper(NCNTModule):
    """Wrapper seguro e compliant para ncnt_cli"""
    ...
    def __init__(self):
        super().__init__(
            module_name="ncnt_cli_wrapper",
            config={"wrapped_module": "ncnt_cli"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "04-Infraestrutura/tools/cli/ncnt_cli.py"
            ...
            self.logger.critical(f"Falha critica em ncnt_cli: {e}")
