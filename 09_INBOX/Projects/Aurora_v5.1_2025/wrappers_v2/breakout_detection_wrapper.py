"""
WRAPPER AUTOMATICO — BREAKOUT_DETECTION → NCNTModule v2.0
...
class breakout_detectionWrapper(NCNTModule):
    """Wrapper seguro e compliant para breakout_detection"""
    ...
    def __init__(self):
        super().__init__(
            module_name="breakout_detection_wrapper",
            config={"wrapped_module": "breakout_detection"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "01-Departamentos/Execution-Trading/strategies/breakout_detection.py"
            ...
            self.logger.critical(f"Falha critica em breakout_detection: {e}")
