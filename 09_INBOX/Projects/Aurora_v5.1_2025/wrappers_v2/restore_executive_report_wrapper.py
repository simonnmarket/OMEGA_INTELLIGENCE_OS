"""
WRAPPER AUTOMATICO — RESTORE_EXECUTIVE_REPORT → NCNTModule v2.0
...
class restore_executive_reportWrapper(NCNTModule):
    """Wrapper seguro e compliant para restore_executive_report"""
    ...
    def __init__(self):
        super().__init__(
            module_name="restore_executive_report_wrapper",
            config={"wrapped_module": "restore_executive_report"}
        )
    ...
    def execute(self, *args, **kwargs):
        ...
        try:
            ...
            module_file = project_root / "00-Governanca/restore_executive_report.py"
            ...
            self.logger.critical(f"Falha critica em restore_executive_report: {e}")
