...
**Report ID:** `e9ce437e79fefd49`  
**Generated:** 2025-12-15 00:51:33 CET  
**Project:** Aurora v3.0  
...
```
complete_integration -> SOPsModule, modules.ncnt_base, asyncio, PreMarketChecklistModule, CoreEngineModule
create_structure -> os, pathlib, io, sys, Path
executive_presentation -> os, pathlib, sys, json, datetime
integrate_ncnt -> modules.ncnt_base, yaml, hashlib, asyncio, sys
main -> .endpoints, fastapi.middleware.cors, strategies, CORSMiddleware, FastAPI
main_ncnt -> NCNTOrchestrator, pathlib, traceback, asyncio, system_core.ncnt_orchestrator_complete
ncnt_scan -> os, pathlib, hashlib, asyncio, Dict
ncnt_system_complete -> yaml, hashlib, asyncio, enum, json
visual_presentation -> os, requests, pathlib, sys, datetime
visual_presentation_simple -> os, requests, pathlib, sys, datetime
audit_system_complete -> hashlib, importlib.util, sys, json, file
complexity_guard -> os, pathlib, Dict, sys, json
generate_complete_report -> os, pathlib, hashlib, AuroraAuditSystem, PhD
genesis_includes -> os, dataclass, pathlib, hashlib, Dict
genesis_includes_v3_complete -> os, dataclass, traceback, hashlib, asyncio
governance_module -> modules.ncnt_base, yaml, hashlib, asyncio, sys
integration_gate_v2 -> modules.ncnt_module_template, os, hashlib, Dict, NCNTModule
integration_gate_v3 -> modules.ncnt_module_template, os, traceback, hashlib, Dict
run_complete_audit -> os, pathlib, sys, ReportGenerator, datetime
__init__ -> NCNTOrchestrator, .orchestrator, .message_bus, NCNTMessageBus, NCNTRegistry
```
