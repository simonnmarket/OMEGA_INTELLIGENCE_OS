...
private:
   ...
   int    m_total_agents; // Total de agentes ativos

public:
   DecisionMatrix() : m_buy_weight(0.0), m_sell_weight(0.0), m_total_agents(0) {}

   // Calcula decisão coletiva com base nos sinais dos agentes
   ...
   // Gera relatório do campo vetorial
   string GenerateStatusReport() {
      string report = "";
      report += "Peso Compra: " + DoubleToString(m_buy_weight, 2) + "\n";
      report += "Peso Venda: " + DoubleToString(m_sell_weight, 2) + "\n";
      return report;
   }
};