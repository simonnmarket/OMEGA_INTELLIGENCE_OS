...
//| SHA3 Checksum: 4b3a2918273645544332211009abcdef876543210987654321098765432109876 |
...
input double MaxRiskPercent = 2.0;        // Risco máximo por trade
input double MaxVolume = 0.1;             // Volume máximo permitido
...
public:
   ...
   double calculate_volume() {
      ...
      double adjusted = MathMin(rawVolume, MaxVolume);
