...
#include <include/neural/quantum_neural_filter.mqh>
#include <include/data/market_data_quantum.mqh>
#include <include/types/trade_signal_enum.mqh>          // Novo: Sistema de sinais
#include <include/quantum/quantum_processor.mqh>         // Novo: Processador quântico
