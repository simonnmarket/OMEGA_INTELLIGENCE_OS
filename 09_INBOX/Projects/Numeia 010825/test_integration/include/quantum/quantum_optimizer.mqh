//+------------------------------------------------------------------+
//| quantum_optimizer.mqh - Otimizador Quântico Avançado            |
...
#include <include/quantum/quantum_annealing_simulator.mqh>
#include <include/quantum/quantum_genetic_algorithm.mqh>
