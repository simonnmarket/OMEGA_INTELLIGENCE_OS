...
class ChartObjectChannel : public CChartObject {
private:
    datetime m_time1;
    datetime m_time2;
    datetime m_time3;
...
public:
    ChartObjectChannel(long chart_id, string name) : CChartObject(chart_id, name) {
        m_time1 = 0;
        m_time2 = 0;
        m_time3 = 0;
        m_price1 = 0;
    ...
    bool Create(long chart_id, datetime time1, double price1, datetime time2, double price2, datetime time3, double price3) {
        ...
        if(!CChartObject::Create(chart_id, OBJ_CHANNEL, 0, time1, price1)) {
            Print("Erro ao criar canal: ", GetLastError());
            return false;
        }
