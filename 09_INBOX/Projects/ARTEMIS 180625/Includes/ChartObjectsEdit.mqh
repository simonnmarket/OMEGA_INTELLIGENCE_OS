...
//| Purpose: Describes functionality of edit field object             |
//+------------------------------------------------------------------+
class CChartObjectEdit : public CChartObject
  {
protected:
   double            m_x;
   double            m_y;
...
public:
   ...
   bool              Create(long chart_id,const string name,int window,double x,double y,double width,double height,const string value="");
   void              Delete(void);

   virtual bool      ChartEvent(const int id,const long &lparam,const double &dparam,const string &sparam);

   //--- Set methods
   bool              Value(const string value);
