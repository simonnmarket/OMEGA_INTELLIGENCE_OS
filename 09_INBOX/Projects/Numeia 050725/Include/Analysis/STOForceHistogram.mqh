//+------------------------------------------------------------------+
//| Include/Analysis/stoForceHistogram.mqh                           |
//| Indicador Institucional: Volume por Pernada + Filtros Inteligentes|
//| Integrado com AuditManager, IA, Swing Buffer Seguro              |
//+------------------------------------------------------------------+
#ifndef __ANALYSIS_STOFORCE_HISTOGRAM__
#define __ANALYSIS_STOFORCE_HISTOGRAM__
