//+------------------------------------------------------------------+
//| VolatilityFilter.mqh - Filtro de Volatilidade                    |
//| Projeto: EA Numeia - Modules                                     |
//| Função: Filtra sinais baseado na volatilidade do mercado        |
//+------------------------------------------------------------------+
#ifndef __VOLATILITY_FILTER__
#define __VOLATILITY_FILTER__

#include <Utils/Log.mqh>  // Adicionado para logging institucional
