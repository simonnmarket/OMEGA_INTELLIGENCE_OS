# ==============================================================================
# PROMETHEUS SILVER V2.3: SISTEMA OPERACIONAL ESPECIALIZADO EM PRATA (XAG)
# Foco: Sistema isolado e independente para XAGUSD, XAGAUD, XAGEUR, XAGGBP
# Data: 26/11/2025
# Magic Number: 99992 (diferente do sistema principal para evitar conflitos)
# ==============================================================================
...
RISK_CONFIG = {
    ...
    'magic': 99992,  # Magic Number diferente do sistema principal (99991)
...
class SistemaOperacional:
    def __init__(self, config):
        ...
        self.log_file = "prometheus_silver_telemetry.log"  # Log específico para Silver
    ...
    def descobrir_ativos_silver(self):
        ...
        self.log_estruturado("discovery_start", {
            "message": "SISTEMA SILVER - Validando símbolos de prata",
        ...
        print(f"🥈 SISTEMA SILVER: {len(symbols_validos)} de {len(SILVER_SYMBOLS)} símbolos válidos")
        if symbols_validos:
            print(f"📊 Símbolos de prata: {', '.join(symbols_validos)}")
        
        return symbols_validos
        
    # --- FUNÇÕES BÁSICAS E DE LOGGING (Mantidas da V2.3) ---
    ...
    def modificar_sl_tp(self, ticket: int, symbol: str, new_sl: float, new_tp: float):
        ...
        request = {
            ...
            "tp": new_tp,
            "magic": self.magic,
            "comment": "PROMETHEUS_SILVER_MOVE_SL",
        }
    ...
    def fechar_posicao_simples(self, posicao_a_fechar, reason="SIGNAL_REVERSAL"):
        ...
        request = {
            ...
            "deviation": 20,
            "magic": self.magic,
            "comment": f"PROMETHEUS_SILVER_SAIDA_{reason}",
    ...
    def executar_ordem_simples(self, symbol: str):
        ...
        try:
            ...
            request = {
                ...
                "deviation": 20, 
                "magic": self.magic,
                "comment": "PROMETHEUS_SILVER_V2.3",
                "type_time": mt5.ORDER_TIME_GTC,
    ...
    def ciclo_operacional(self):
        ...
        self.log_estruturado("cycle_start", {
            "version": "PROMETHEUS SILVER V2.3",
            "timestamp": datetime.now().isoformat()
        }, print_to_console=False)
        
        print(f"\n==================================================")
        print(f"🔄 CICLO INICIADO: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
        print(f"   SISTEMA: PROMETHEUS SILVER V2.3 (Prata XAG)")
        print(f"==================================================")
...
def main():
    ...
    if sistema.conectar_mt5():
        ...
        print(f"🥈 SISTEMA SILVER V2.3 INICIADO!")
        print(f"📊 Monitorando {len(sistema.symbols)} símbolos de prata: {', '.join(sistema.symbols)}")
        print(f"🔢 Magic Number: {sistema.magic} (isolado do sistema principal)")
