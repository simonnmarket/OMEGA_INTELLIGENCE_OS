...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    try:
        # Initialize components (TIER-0 Integrated)
        ...
        from system_core.async_orchestrator import AsyncOrchestrator
        from api.tier0_endpoints import set_orchestrator, set_auth_middleware
...
# Include routers
from api.tier0_endpoints import router as api_router
